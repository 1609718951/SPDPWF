...
class Instance:
    ...
    def write_to_txt(self, exp_index):
        file_name = "/Users/whp/Desktop/大论文/spdp/source/exp/test/{}-{}-{}-{}.tex".format(self.num_order, self.num_station, self.num_vehicle, exp_index)
        with open(file_name, 'a') as f:
            ...
            for orders, details in self.order_dic.items():
                f.write(f'{orders}\t')
                f.write('{}\t{}\t{}\t{}\n'.format(details.start, details.end, details.shelf_life, [details.timeWindow.get_earliest_time(),details.timeWindow.get_latest_time()]))
